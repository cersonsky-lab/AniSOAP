class CGRCacheList:
    ...
    def keys(self) -> list[int]:
        ...
        """
        return [entry[0] & CGRCacheList._REMOVE_RFLAG for entry in self._cyclic_list if entry is not None]
    ...
    def insert(self, key: int, value: dict) -> None:
        ...
        if key not in self.keys():
            ...
            while curr_entry is not None and curr_entry[0] & CGRCacheList._GET_RFLAG != 0:
