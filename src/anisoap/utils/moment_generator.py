        ...
        for n0 in range(deg+1):
            for n1 in range(deg+1-n0):
                ...
                if n0 == 0:
                    ...
                    if n1 > 0:
                        moments[n0,n1+1,n2] += cov[1,1]*n1*moments[n0,n1-1,n2]
                    if n2 > 0:
                        moments[n0,n1+1,n2] += cov[1,2]*n2*moments[n0,n1,n2-1]

                    if n0 == 0 and n1 == 0:
                        # Run the z-iteration
                        moments[n0,n1,n2+1] = a[2]*moments[n0,n1,n2] + cov[2,2]*n2*moments[n0,n1,n2-1]
